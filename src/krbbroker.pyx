import sys
include "krabbe.pyx"
include "krabbe_terminal.pyx"
include "krabbe_log.pyx"
include "krabbe_cmd.pyx"
include "krabbe_cmd2.pyx"
include "krabbe_cmd3.pyx"
include "krabbe_cmd4.pyx"


class KRABBECMD_BROKER(KRABBECMD_GEN, KRABBECMD_KEYRING, KRABBECMD_HELP, KRABBECMD_ZMQ_SUB, KRABBECMD_ZMQ_PUB,
                       KRABBECMD_BUS, KRABBECMD_LOCAL, KRABBECMD_DB, KRABBECMD_INTRO, KRABBECMD_WORKERS,
                       KRABBECMD_TERMINAL, KRABBECMD_LOG):
    def __init__(self):
        self.doc = []
        self.log = None
        ...
        KRABBECMD_WORKERS.__init__(self)
        KRABBECMD_TERMINAL.__init__(self)
        KRABBECMD_LOG.__init__(self)
